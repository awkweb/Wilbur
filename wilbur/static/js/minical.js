(function() {
  ...
  minical = {
    ...
    render: function(date) {
      ...
      if (this.show_today_link || !this.initialize_with_date) {
        templates.today_link().insertAfter($li.find("table"));
      }
      ...
      $li.find("." + (date_tools.getDayClass(new Date()))).addClass("minical_today_date");
